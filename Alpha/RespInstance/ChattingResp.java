...
public class ChattingResp extends BroadcasetResponding {
    ...
    public Message msgInput(AlphaMessageInputStream acceptor) {
        ...
        if(msg != null){
            System.out.println("接收信息:" + msg.readString());
        }
        return msg;
    }
    ...
    public boolean resultBack(AlphaMessageOutputStream rebacker, ClientMessage[] lostingClientMsgs, Exception[] causes, boolean run) {

        Message rbmsg = new Message();
